...
ActiveRecord::Schema.define(version: 2020_03_31_035850) do
  create_table 'addresses',
    ...
    t.integer 'status',
              limit: 1, default: 1, comment: '0=>disabled 1=>enabled 2=>default'
    t.string 'city'
    t.string 'state'
    t.string 'country'
    ...
    t.index %w[first_name],
            name: 'index_addresses_on_first_name', type: :fulltext
    t.index %w[last_name], name: 'index_addresses_on_last_name', type: :fulltext
  end
  ...
  create_table 'admin_users',
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[email], name: 'index_admin_users_on_email', unique: true
  end
  ...
  create_table 'carts',
    ...
    t.index %w[device_type], name: 'index_carts_on_device_type'
    t.index %w[product_id], name: 'index_carts_on_product_id'
  ...
  create_table 'devices',
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[device_id], name: 'index_devices_on_device_id'
    t.index %w[device_type], name: 'index_devices_on_device_type'
    t.index %w[status], name: 'index_devices_on_status'
    t.index %w[user_id], name: 'index_devices_on_user_id'
  end

  create_table 'guest_carts',
               id: :integer,
               unsigned: true,
               options:
                 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
    ...
    t.integer 'quantity', default: 0, unsigned: true
    t.integer 'device_type', default: 0, unsigned: true
    t.index %w[device_type], name: 'index_guest_carts_on_device_type'
    t.index %w[product_id], name: 'index_guest_carts_on_product_id'
    t.index %w[token_id], name: 'index_guest_carts_on_token_id'
  end
  ...
  create_table 'order_products',
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[order_id], name: 'index_order_products_on_order_id'
    t.index %w[product_id], name: 'index_order_products_on_product_id'
  end
  ...
  create_table 'orders',
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[address_id], name: 'index_orders_on_address_id'
    t.index %w[device_type], name: 'index_orders_on_device_type'
    t.index %w[is_confirm], name: 'index_orders_on_is_confirm'
    t.index %w[parent_id], name: 'index_orders_on_parent_id'
    t.index %w[retailer status created_at],
            name: 'index_orders_on_retailer_and_status_and_created_at'
    t.index %w[retailer], name: 'index_orders_on_retailer'
    t.index %w[status], name: 'index_orders_on_status'
  ...
  create_table 'products',
    ...
    t.integer 'status',
              limit: 1,
              default: 0,
              comment: '0=>disabled,1=>enabled,2=>Discontinued, 3=>Comming soon'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[status], name: 'index_products_on_status'
    t.index %w[url], name: 'index_products_on_url', unique: true
  end
  ...
  create_table 'subscribers',
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[device_type], name: 'index_subscribers_on_device_type'
    t.index %w[email], name: 'index_subscribers_on_email', unique: true
  end
  ...
  create_table 'users',
    ...
    t.index %w[first_name], name: 'index_users_on_first_name', type: :fulltext
    t.index %w[last_name], name: 'index_users_on_last_name', type: :fulltext
    t.index %w[status], name: 'index_users_on_status'
  end
end
